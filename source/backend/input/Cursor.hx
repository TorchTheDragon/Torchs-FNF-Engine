...
class Cursor {
    ...
    public static inline function toggle(on:Bool = false):Void {
        if (FlxG.mouse.visible && !on) hide();
        else show();
    }
    ...
    public static final CURSOR_ZOOM_OUT_PARAMS:CursorParams = {
        graphic: "assets/shared/images/cursor/cursor-",
        scale: 1.0,
        offsetX: 0,
        offsetY: 0
    };
    ...
    static function setCursorGraphic(?value:CursorMode = null):Void {
        ...
        switch (value) {
            case Default:
                ...
                } else applyCursorParams(assetCursorDefault, CURSOR_DEFAULT_PARAMS);
            case Cross:
                ...
                } else applyCursorParams(assetCursorCross, CURSOR_CROSS_PARAMS);
            case Eraser:
                ...
                } else applyCursorParams(assetCursorEraser, CURSOR_ERASER_PARAMS);
            case Grabbing:
                ...
                } else applyCursorParams(assetCursorGrabbing, CURSOR_GRABBING_PARAMS);
            case Hourglass:
                ...
                } else applyCursorParams(assetCursorHourglass, CURSOR_HOURGLASS_PARAMS);
            case Pointer:
                ...
                } else applyCursorParams(assetCursorPointer, CURSOR_POINTER_PARAMS);
            case Text:
                ...
                } else applyCursorParams(assetCursorText, CURSOR_TEXT_PARAMS);
            case ZoomIn:
                ...
                } else applyCursorParams(assetCursorZoomIn, CURSOR_ZOOM_IN_PARAMS);
            case ZoomOut:
                ...
                } else applyCursorParams(assetCursorZoomOut, CURSOR_ZOOM_OUT_PARAMS);
            case Crosshair:
                ...
                } else applyCursorParams(assetCursorCrosshair, CURSOR_CROSSHAIR_PARAMS);
            case Cell:
                ...
                } else applyCursorParams(assetCursorCell, CURSOR_CELL_PARAMS);
            case Scroll:
                ...
                } else applyCursorParams(assetCursorScroll, CURSOR_SCROLL_PARAMS);
            default:
